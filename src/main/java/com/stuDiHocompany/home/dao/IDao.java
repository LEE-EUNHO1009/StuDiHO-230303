...
public interface IDao {
	...
	public ArrayList<ReservationListDto> list02Dao(String rid); // 프로필/컨셉 예약리스트 가져오기
	public ArrayList<ReservationListDto> list03Dao(String rid); // 반려동물 예약리스트 가져오기
	...
	public int count02List(String rid); // 프로필/컨셉 촬영 예약 건수
	public int count03List(String rid); // 반려동물 촬영 예약 건수
