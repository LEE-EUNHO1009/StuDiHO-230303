...
public interface IDao {
	...
	public void qdeleteAllDao(String qid); // 해당 아이디의 문의 전체 삭제
	   ...
	   public List<QuestionListDto> questionList(Criteria cri);//질문게시판 리스트 가져오기 select
	   public QuestionListDto questionView(String qnum);//선택한 글 번호의 정보 가져오기 select
	...
	public int cancelDao(String mid, String mpw); // 회원탈퇴
