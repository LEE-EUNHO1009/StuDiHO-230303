...
<body>
	...
	<a href="${pageContext.request.contextPath }/resources/img/4.jpg">
		<img src="${pageContext.request.contextPath }/resources/img/4.jpg" width="300" height="380"><br><br>
	</a>
	...
	<a href="${pageContext.request.contextPath }/resources/img/1.jpg">
		<img src="${pageContext.request.contextPath }/resources/img/1.jpg" width="300" height="380"><br><br>
	</a>
	<br><br>
